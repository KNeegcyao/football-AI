...
import com.soccer.forum.service.modules.community.model.PostCreateReq;
...
import com.soccer.forum.service.modules.user.service.LikeService;
    ...
    public Long createPost(PostCreateReq req, Long userId) {
        ...
        if (post.getTopicId() != null) {
            ...
            if (topic != null) {
                ...
                log.debug("更新话题讨论。topicId={}, newCount={}", topic.getId(), topic.getPostCount());
            }
        }
