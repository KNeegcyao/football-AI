...
import com.soccer.forum.service.modules.match.mapper.TeamFollowMapper;
...
public class TeamServiceImpl implements TeamService {
    ...
    private void populateTeamStats(Team team) {
        ...
        // 填充关注者数
        Long followerCount = teamFollowMapper.selectCount(new LambdaQueryWrapper<TeamFollow>()
    ...
    public int getOnlineCount(Long teamId) {
        ...
        // 兜底策略：如果真实人数为0，且有关注者，则返回一个模拟的小数值，否则返回真实
        if (realCount == 0) {
            Long followerCount = teamFollowMapper.selectCount(new LambdaQueryWrapper<TeamFollow>()
    ...
    public Page<Team> listTeams(Integer page, Integer size, String keyword, Boolean isHot) {
        ...
        Page<Team> teamPage = new Page<>(page != null ? page : 1, size != null ? size : 10);
     ...
     * @throws ServiceException 当球队不存在时抛
     */
    @Override
    @Transactional(rollbackFor = Exception.class)
