...
import com.soccer.forum.service.modules.system.model.NotificationResp;
import com.soccer.forum.service.modules.user.model.LoginUser;
import com.soccer.forum.service.modules.user.model.UserSimpleResp;
...
public class NotificationController {
    ...
    public R<Page<NotificationResp>> list(@Parameter(description = "页码") @RequestParam(defaultValue = "1") Integer page,
                                          ...
                                          @Parameter(description = "多个类型过滤 (逗号分隔，兼容旧版本") @RequestParam(required = false) String types,
        ...
        List<NotificationResp> resps = notificationPage.getRecords().stream().map(notification -> {
            ...
            if (notification.getType() == 1 || notification.getType() == 3) {
                ...
                // 2:点赞评论, 4:回复评论, 6:@提及 -> targetId 为 commentId
