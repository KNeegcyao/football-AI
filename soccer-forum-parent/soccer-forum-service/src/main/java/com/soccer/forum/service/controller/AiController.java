...
public class AiController {
    ...
    public Map<String, String> generateComment(@RequestBody Map<String, String> body) {
    ...
    public Map<String, String> generateMatchReport(@RequestBody Map<String, String> body) {
     ...
     * 战术分析接口
     *
     * @param tacticalInfo 战术/阵容信息
     * @return 战术分析结果
     */
    @Operation(summary = "战术分析", description = "根据阵容或描述进行战术分析")
    @PostMapping("/tactics/analyze")
    public Map<String, String> analyzeTactics(@RequestBody Map<String, String> body) {
